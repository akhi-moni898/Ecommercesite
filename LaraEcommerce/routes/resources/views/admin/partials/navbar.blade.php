<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block">Login</li>
            <li class="nav-item dropdown language-dropdown">
              <a class="nav-link dropdown-toggle px-2 d-flex align-items-center" id="LanguageDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <span class="profile-text font-weight-medium d-none d-md-block">Registration</span>
              </a>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.pages.product.create')}}">Create Product</a>
                  </li>
                  <li class="nav-item">
     ...
     <li class="nav-item">
              ...
              <div class="collapse" id="category-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.pages.category.create')}}">Create Category</a>
                  </li>
              ...
              <div class="collapse" id="division-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.pages.division.create')}}">Create Division</a>
                  </li>
             ...
             <li class="nav-item">
              ...
              <div class="collapse" id="district-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.pages.district.create')}}">Create District</a>
                  </li>
        ...
        <li class="nav-item">
              ...
              <div class="collapse" id="brand-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.pages.brand.create')}}">Create Brand</a>
                  </li>
