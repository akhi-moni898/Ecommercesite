         ...
         <div class="card-body">
                    <form method="POST" action="{{ route('user.profile.update') }}">
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="street_address" type="street_address" class="form-control @error('street_address') is-invalid @enderror" name="street_address" value=" {{$user->last_name}}" required autocomplete="street_address">
